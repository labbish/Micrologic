...
const std::map<std::string, std::string> en_us = {
	...
	{"CHECK_INPUTS","Input lines are: "},
	{"CHECK_OUTPUT","No.%d output line is line No.%d.\n"},
	{"CHECK_OUTPUTS","Output lines are: "},
	{"TAG","No.%d line is: "},{"TAG--","neither input nor output.\n"},{"TAGI-","input.\n"},{"TAG-O","output.\n"},{"TAGIO","both input and output.\n"},
...
const std::map<std::string, std::string> zh_cn = {
	...
	{"CHECK_INPUTS","所有输入线的编号是："},
	{"CHECK_OUTPUT","第%d条输出线的线编号是%d。\n"},
	{"CHECK_OUTPUTS","所有输出线的编号是："},
	{"TAG","第%d条线是："},{"TAG--","既非输入也非输出。\n"},{"TAGI-","输入。\n"},{"TAG-O","输出。\n"},{"TAGIO","既是输入也是输出。\n"},
	{"TYPE","第%d条线是："},{"TYPEL","线。\n"},{"TYPEW","宽线。\n"},
